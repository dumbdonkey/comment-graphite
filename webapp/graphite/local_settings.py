...
STORAGE_DIR = '/data0/datas/graphite/storge'
STATIC_ROOT = '/opt/graphite/static'
LOG_DIR = '/data0/datas/graphite/log'
INDEX_FILE = '/data0/datas/graphite/storage/index'     # Search index file
...
#
CERES_DIR = '/data0/datas/graphite/storage/ceres'
WHISPER_DIR = '/data0/datas/graphite/storage/whisper'
RRD_DIR = '/data0/datas/graphite/storage/rrd'
#
...
DATABASES = {
    'default': {
        'NAME': '/data0/datas/graphite/storage/graphite.db',
